...
public class AccountService {
    ...
    public AccountService(CreateAccount createAccount, GetAllAccounts getAllAccounts, GetAccountById getAccountById, UpdateAccount updateAccount, DeleteAccount deleteAccount) {
